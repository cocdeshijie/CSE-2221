...
public final class RSSAggregator {
    ...
    private static void processItem(XMLTree item, SimpleWriter out) {
         ...
         */
        String titleString = "No title available", linkString;
        ...
        if (getChildElement(item, "description") != -1
                && titleString.equals("No title available")) {
    ...
    private static void processFeed(String url, String file, SimpleWriter out) {
        ...
        if (xml.label().equals("rss")
            ...
            out.println("Invalid RSS link: " + url);
        }
        outHTML.close();
    }
    ...
    public static void main(String[] args) {
         ...
         * TODO: fill in body
         */
        out.println("Enter the URL of RSS v2.0 feeds: ");
        ...
        if (xml.label().equals("feeds")) {
            ...
            // HTML opening tags
            outHTML.println("<html> <head> <title>" + title + "</title>");
            outHTML.println("</head> <body>");
            outHTML.println("<h2>" + title + "</h2>");
            outHTML.println("<ul>");
            // 1 or more <feed> tags
            for (int i = 0; i < xml.numberOfChildren(); i++) {
                if (xml.child(i).label().equals("feed")) {
                    XMLTree feed = xml.child(i);
                    // url, name, and file attributes required.
                    String xmlUrl, xmlName, xmlFile;
                    xmlUrl = feed.attributeValue("url");
                    xmlName = feed.attributeValue("name");
                    xmlFile = feed.attributeValue("file");
                    // list item
                    outHTML.println("<li><a href='" + xmlFile + "'>" + xmlName
                            + "</a></li>");
                    processFeed(xmlUrl, xmlFile, out);
                }
            }
            // HTML closing tags
            outHTML.println("</ul></body></html>");
        } else {
            out.println("Invalid RSS Feeds Link.");
        }
